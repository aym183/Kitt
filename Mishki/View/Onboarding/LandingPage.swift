            ...
            ZStack {
                VStack {
                    if Auth.auth().currentUser != nil {
                        HomePage(isShownHomePage: true, isShownProductCreated: false, isShownLinkCreated: false)
                    } else {
                        LandingContent()
                    }
                }
            ...
            GeometryReader { geometry in
                ZStack {
                    ...
                    .navigationDestination(isPresented: $homePageShown) {
                        HomePage(isShownHomePage: true, isShownProductCreated: false, isShownLinkCreated: false).navigationBarHidden(true)
                    }
                }
            }
    }
